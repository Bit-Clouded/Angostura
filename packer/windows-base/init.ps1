...
$wr2Parameters = @{
    Uri = 'https://prod-cicdshared-utility-1hzwhron259mj.s3-eu-west-1.amazonaws.com/glenlivet/CloudWatchAgentConfig/agent-config.json'
...
$wr3Parameters = @{
    Uri = 'https://prod-cicdshared-utility-1hzwhron259mj.s3-eu-west-1.amazonaws.com/glenlivet/CloudWatchAgentConfig/configureCloudWatch.ps1'
